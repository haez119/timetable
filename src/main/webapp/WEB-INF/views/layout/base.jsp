...
<html>
  ...
  <body>
    ...
    <div class="site-wrap" id="home-section">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col">
              <div class="site-logo">
                <a href="index.html"><strong>TimeTable</strong></a>
              </div>
            </div>
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                   <c:if test="${sessionScope.student.st_id eq null }" >
                   	<li class="active"><a href="#" class="nav-link">로그인 후 이용가능합니다.</a></li>
                   </c:if>
                  ...
                  <li class="has-children">
                    <a href="practice-areas.html" class="nav-link">My Page</a>
                    <ul class="dropdown">
      ...
      <footer class="site-footer" style="background-image: url('${pageContext.request.contextPath}/resources/images/hero_bg_footer.jpg')">
        <div class="container">
          <div class="row">
            <div class="col-lg-3">
